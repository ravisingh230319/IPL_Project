...
public class Ipl {
    ...
    static List<Map.Entry<String, Float>> sortedEconomy;
    static List<Map.Entry<String, Integer>> sortedWickets;

    static void readMatchesAndDeliveriesData(){
        String matchesPath = "src/com/ipl/dataset/matches.csv";
        String deliveriesPath = "src/com/ipl/dataset/deliveries.csv";
        String matchesLine;
        ...
        sortedWickets = new ArrayList<>(top10WicketTakingBowlersInAllSeason.entrySet());
        sortedWickets.sort((wicket1, wicket2) -> wicket2.getValue().compareTo(wicket1.getValue()));
    }

    static void getMatchesPerYear(String matchesLine){
        String[] match;
    ...
    static void getMatchesWonByAllTeamInAllYear(String matchesLine) {
        String[] match;
        match = matchesLine.split(",");
        String winnerTeam = match[10];

        if(!winnerTeam.equals("")){
            if(matchesWonByAllTeamInAllYear.containsKey(winnerTeam)) {
    ...
    static void getExtraRunsConcededPerTeamIn2016(ArrayList<String> matchesId, String deliveriesLine){
        String[] delivery;
    ...
    static void topEconomicalBowlersIn2015(ArrayList<String> matchesId, String deliveriesLine)
    {
        String[] delivery;
        delivery = deliveriesLine.split(",");
        ...
        if(matchesId.contains(delivery[0]))
        {
            ...
            if(legalDelivery.containsKey(bowlerName) && totalRuns.containsKey(bowlerName)) {
    ...
    static void getTossWonByAllTeamInAllYear(String matchesLine) {
        String[] match;
        match = matchesLine.split(",");
    ...
    static void getTotalManOfMatchForPlayerIn2016(String matchesLine) {
        String[] match;
        match = matchesLine.split(",");
    ...
    static void getNoOfSixesHitByDhoniInAllSeason(String deliveriesLine){
        String[] delivery;
        delivery = deliveriesLine.split(",");
    ...
    static void getNoOfCatchesByFielderIn2015(ArrayList<String> matchesId, String deliveriesLine){
        String[] delivery;
        delivery = deliveriesLine.split(",");
    ...
    static void getNoOfBoundariesHitByKohliInAllSeason(String deliveriesLine){
        String[] delivery;
        delivery = deliveriesLine.split(",");
        int batsmanRuns = Integer.parseInt(delivery[15]);
        String batsmanName = delivery[6];
    ...
    static void getTop10WicketTakingBowlersInAllSeason(String deliveriesLine){
        String[] delivery;
        delivery = deliveriesLine.split(",");
        String dismissalKind = "";
